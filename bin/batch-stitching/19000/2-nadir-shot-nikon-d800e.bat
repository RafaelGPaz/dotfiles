...
copy "%~1" "E:\_temp_\stitching_output\nadir-shot.jpg" > nul
echo [ OK ] Copy nadir-shot.jpg

REM path to PTGui then batch command with path to template. -x: Exit when done
"C:\Program Files\PTGui\PTGui.exe" -batch "C:\Users\Rafael\AppData\Roaming\PTGui\Templates\2-nadir-shot-nikon-d800e.pts" -x
...
copy "E:\_temp_\stitching_output\nadir-looking-down.tif" "%~dp1\_nadir-looking-down.tif" > nul
echo [ OK ] Copy nadir-looking-down.tif

REM Delete copied images from temp folder.
del "E:\_temp_\stitching_output\nadir-looking-down.tif"
